    ...
    <main>
        <div class="reisinfoachtergrond flex">
            <div class="reisinformatieborder flex">
                <?php if (isset($_SESSION['boeking'])): ?>
                    <div class="boekingsitems">
                        <h1>Uw geboekte reis:</h1>
                        <p>Stad: <?php echo htmlspecialchars($_SESSION['boeking']['stad']); ?></p>
                        <p>Bestemming: <?php echo htmlspecialchars($_SESSION['boeking']['dealbestemming']); ?></p>
                        <p>Prijs: €<?php echo htmlspecialchars($_SESSION['boeking']['prijs']); ?></p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
